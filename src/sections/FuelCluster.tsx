...
const TIERS = [
    {
        ...
        features: ['Real-time Dev-Liq Signals', 'Basic AI Terminal Access', 'Standard Cluster Karma'],
        icon: Target,
    ...
    },
    {
        ...
        features: ['Priority Signal Uplink', 'Advanced Pattern Recognition', '2x Cluster Karma Multiplier', 'Private Agent Channels'],
        icon: Zap,
    ...
    },
    {
        ...
        features: ['Infinite Uplink Duration', 'Max Karma Allocation', 'Early Access to New Agents', 'Founding Member Status'],
        icon: Shield,
        color: 'text-white',
