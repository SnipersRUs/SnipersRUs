import {
  ...
  withRetry,
  withTimeout
} from "./chunk-CGDQXNVN.js";
import "./chunk-TL3BP6NJ.js";
import "./chunk-WLOCSX57.js";
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-YRPBHZWA.js";
import "./chunk-AKYJBAUK.js";
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const { GeminiWalletProvider } = await (() => {
          try {
            return import("./connectors-KYFQFC3Q.js");
          } catch {
      ...
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await (() => {
            try {
              return import("./connectors-PIKCVVZL.js");
            } catch {
